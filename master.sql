...
VALUES (10, 2, 'N', 'Y',
 ...
 INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(  --CODE
  ...
  PARAM_VALUE,
  INDEX_SEQ)
VALUES (-1, 11, 'Y', 'N','SEED','MASTER', 'MATTER IDENTIFIED_CD', 'How was this matter identified?', 0);
 ...
 INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(
  ...
  PARENT_ITEM_TYPE,  CHILD_ITEM_TYPE,  PARAM_NAME,          PARAM_VALUE,  INDEX_SEQ)
VALUES (11, 1, 'N', 'Y',
   'SEED',          'MASTER',         'IDENTIFIED_CD', 'CLIENT REPORTED', 1);
...
INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(
  ...
  PARENT_ITEM_TYPE,  CHILD_ITEM_TYPE,  PARAM_NAME,          PARAM_VALUE,  INDEX_SEQ)
VALUES (11, 2, 'N', 'Y',
   'SEED',          'MASTER',         'IDENTIFIED_CD', 'BANKER IDENTIFIED', 2);
 ...
 INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(
  ...
  PARENT_ITEM_TYPE,  CHILD_ITEM_TYPE,  PARAM_NAME,          PARAM_VALUE,  INDEX_SEQ)
VALUES (11, 3, 'N', 'Y',
   'SEED',          'MASTER',         'IDENTIFIED_CD', 'OTHER FRB BUSINESS UNIT IDENTIFIED', 1);
...
INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(
  ...
  PARENT_ITEM_TYPE,  CHILD_ITEM_TYPE,  PARAM_NAME,          PARAM_VALUE,  INDEX_SEQ)
VALUES (11, 4, 'N', 'Y',
   'SEED',          'MASTER',         'IDENTIFIED_CD', 'OTHER FINANCIAL INSTITUTION', 2);
...
INSERT INTO SAMPLE_DATA.dbo.FRAUD_INTAKE_REF(
  ...
  PARENT_ITEM_TYPE,  CHILD_ITEM_TYPE,  PARAM_NAME,          PARAM_VALUE,  INDEX_SEQ)
VALUES (11, 5, 'N', 'Y',
   'SEED',          'MASTER',         'IDENTIFIED_CD', 'OTHER', 2);  
